<?php
namespace dgonzales351\Cnm\DataDesign;

require_once(dirname(__DIR__, 2) . "/vendor/Author.php");

use dgonzales351\Uuid\Uuid;
/**
...
private $AuthorId;
	 ...
	 **/
	public function setPAuthorAtHandle(string $newAuthorAtHandle) : void {
		...
		// store the at handle
		$this->AuthorAtHandle = $newAuthorUsername;
	}
	/**
